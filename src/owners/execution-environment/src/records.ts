...
export type BoundedExecutorActionKind = "agent.workflow" | "capability.package-action" | "custom";
...
export type CustomHandlerOutput = Pick<BoundedExecutorOutputRecord, "label" | "mediaType" | "body">;
export type CustomActionHandler = (input: Readonly<BoundedExecutorSubmission>) => Promise<CustomHandlerOutput[]> | CustomHandlerOutput[];
